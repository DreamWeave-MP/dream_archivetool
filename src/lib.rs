...
//!
//! `dream_archivetool` wraps the [`dream_archive`] crate behind a small, application-oriented API that is
...
//! Lua/module integration even when `dream_archivetool` policy APIs do not change.
//!
//! # Example
//!
//! ```no_run
